document.addEventListener("keydown",function(event){
    ...
    switch(key){
        ...
        case 'w':
                ...
                document.getElementById("audioW").play(key);
                break;
        case 'e':
                document.getElementById("audioE").currentTime=0;
                document.getElementById("audioE").play(key);
                break;
        case 't':
                document.getElementById("audioT").currentTime=0;
                document.getElementById("audioT").play(key);
                break;
        case 'y':
                document.getElementById("audioY").currentTime=0;
                document.getElementById("audioY").play(key);
                break;
        case 'u':
                document.getElementById("audioU").currentTime=0;
                document.getElementById("audioU").play(key);
                break;
    }
    ...
    let W = document.querySelector("#box8P");
    W.addEventListener("click",function(){
        document.getElementById("audioW").currentTime=0;
        document.getElementById("audioW").play(key);
    })
    let E = document.querySelector("#box9P");
    E.addEventListener("click",function(){
        document.getElementById("audioE").currentTime=0;
        document.getElementById("audioE").play(key);
    })
    let T = document.querySelector("#box10P");
    T.addEventListener("click",function(){
        document.getElementById("audioT").currentTime=0;
        document.getElementById("audioT").play(key);
    })
    let Y = document.querySelector("#box11P");
    Y.addEventListener("click",function(){
        document.getElementById("audioY").currentTime=0;
        document.getElementById("audioY").play(key);
    })
    let U = document.querySelector("#box12P");
